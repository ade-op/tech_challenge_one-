...
pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '381492260180.dkr.ecr.us-east-1.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '381492260180.dkr.ecr.us-east-1.amazonaws.com/devops-challenge-backend'
    }
